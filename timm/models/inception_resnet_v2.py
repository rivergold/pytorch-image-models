...
default_cfgs = {
    ...
    'inception_resnet_v2': {
        'url':
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/inception_resnet_v2-940b1cd6.pth',
        'num_classes': 1001,
    ...
    'ens_adv_inception_resnet_v2': {
        'url':
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/ens_adv_inception_resnet_v2-2592a550.pth',
        'num_classes': 1001,
        'input_size': (3, 299, 299),
        'pool_size': (8, 8),
        'crop_pct': 0.8975,
...
class InceptionResnetV2(nn.Module):
    def __init__(self,
        ...
        self.feature_info += [
            dict(num_chs=192, reduction=4, module='conv2d_4a')
        ]
        ...
        self.repeat_1 = nn.Sequential(Block17(scale=0.10), Block17(scale=0.10),
                                      ...
                                      Block17(scale=0.10), Block17(scale=0.10))
        self.feature_info += [
            dict(num_chs=1088, reduction=16, module='repeat_1')
        ]
        ...
        self.conv2d_7b = BasicConv2d(2080,
                                     self.num_features,
                                     kernel_size=1,
                                     stride=1)
        self.feature_info += [
...
def _create_inception_resnet_v2(variant, pretrained=False, **kwargs):
    return build_model_with_cfg(InceptionResnetV2,
                                variant,
                                pretrained,
...
def inception_resnet_v2(pretrained=False, **kwargs):
    ...
    """
    return _create_inception_resnet_v2('inception_resnet_v2',
...
def ens_adv_inception_resnet_v2(pretrained=False, **kwargs):
    ...
    """
    return _create_inception_resnet_v2('ens_adv_inception_resnet_v2',
                                       pretrained=pretrained,
                                       **kwargs)
