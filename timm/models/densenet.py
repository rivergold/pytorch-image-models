...
default_cfgs = {
    ...
    'densenet169':
    _cfg(url='https://download.pytorch.org/models/densenet169-b2777c0a.pth'),
    'densenet201':
    _cfg(url='https://download.pytorch.org/models/densenet201-c1103571.pth'),
    'densenet161':
    _cfg(url='https://download.pytorch.org/models/densenet161-8d451a50.pth'),
    'densenet264':
    _cfg(url=''),
    'densenet264d_iabn':
    _cfg(url=''),
    'tv_densenet121':
    _cfg(url='https://download.pytorch.org/models/densenet121-a639ec97.pth'),
}
    ...
    def __init__(self,
        ...
        if deep_stem:
            ...
            if 'tiered' in stem_type:
                ...
                stem_chs_2 = num_init_features if 'narrow' in stem_type else 6 * (
                    growth_rate // 4)
        ...
        for i, num_layers in enumerate(block_config):
            ...
            if i != len(block_config) - 1:
                self.feature_info += [
                    dict(num_chs=num_features,
                         reduction=current_stride,
                         module='features.' + module_name)
                ]
                current_stride *= 2
                trans = DenseTransition(num_input_features=num_features,
...
def densenet121(pretrained=False, **kwargs):
    ...
    """
    model = _create_densenet('densenet121',
                             growth_rate=32,
                             block_config=(6, 12, 24, 16),
...
def densenetblur121d(pretrained=False, **kwargs):
    ...
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`
    """
    model = _create_densenet('densenetblur121d',
                             growth_rate=32,
                             block_config=(6, 12, 24, 16),
                             pretrained=pretrained,
                             stem_type='deep',
...
def densenet121d(pretrained=False, **kwargs):
    ...
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`
    """
    model = _create_densenet('densenet121d',
                             growth_rate=32,
                             block_config=(6, 12, 24, 16),
                             stem_type='deep',
                             pretrained=pretrained,
...
def densenet169(pretrained=False, **kwargs):
    ...
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`
    """
    model = _create_densenet('densenet169',
                             growth_rate=32,
...
def densenet201(pretrained=False, **kwargs):
    ...
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`
    """
    model = _create_densenet('densenet201',
                             growth_rate=32,
...
def densenet161(pretrained=False, **kwargs):
    ...
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`
    """
    model = _create_densenet('densenet161',
                             growth_rate=48,
...
def densenet264(pretrained=False, **kwargs):
    ...
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`
    """
    model = _create_densenet('densenet264',
                             growth_rate=48,
...
def densenet264d_iabn(pretrained=False, **kwargs):
    ...
    model = _create_densenet('densenet264d_iabn',
                             growth_rate=48,
                             block_config=(6, 12, 64, 48),
                             stem_type='deep',
...
def tv_densenet121(pretrained=False, **kwargs):
    ...
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`
    """
    model = _create_densenet('tv_densenet121',
                             growth_rate=32,
                             block_config=(6, 12, 24, 16),
                             pretrained=pretrained,
                             **kwargs)
