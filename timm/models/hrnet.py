...
default_cfgs = {
    ...
    _cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-hrnet/hrnet_w18_small_v1-f460c6bc.pth'
    ),
    'hrnet_w18_small_v2':
    _cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-hrnet/hrnet_w18_small_v2-4c50a8cb.pth'
    ),
    'hrnet_w18':
    _cfg(
        url=
    ...
    _cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-hrnet/hrnetv2_w30-8d7f8dab.pth'
    ),
    'hrnet_w32':
    _cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-hrnet/hrnetv2_w32-90d8c5fb.pth'
    ),
    'hrnet_w40':
    _cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-hrnet/hrnetv2_w40-7cd397a4.pth'
    ),
    'hrnet_w44':
    _cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-hrnet/hrnetv2_w44-c9ac8c18.pth'
    ),
    'hrnet_w48':
    _cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-hrnet/hrnetv2_w48-abd2e6ab.pth'
    ),
    'hrnet_w64':
    _cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-hrnet/hrnetv2_w64-b47cc881.pth'
    ),
}

cfg_cls = dict(hrnet_w18_small=dict(
    STEM_WIDTH=64,
    STAGE1=dict(
        NUM_MODULES=1,
        NUM_BRANCHES=1,
...
class HighResolutionNet(nn.Module):
    def __init__(self,
        ...
        self.conv2 = nn.Conv2d(stem_width,
                               64,
                               kernel_size=3,
                               stride=2,
                               padding=1,
        ...
        self.feature_info = [
            dict(num_chs=64, reduction=curr_stride, module='stem')
        ]
    ...
    def _make_head(self, pre_stage_channels, incre_only=False):
        ...
        for i, channels in enumerate(pre_stage_channels):
            incre_modules.append(
                self._make_layer(head_block,
                                 channels,
                                 self.head_channels[i],
                                 1,
                                 stride=1))
        ...
        final_layer = nn.Sequential(
            nn.Conv2d(in_channels=self.head_channels[3] * head_block.expansion,
...
class HighResolutionNetFeatures(HighResolutionNet):
    ...
    def __init__(self,
        ...
        super(HighResolutionNetFeatures,
              self).__init__(cfg,
                             in_chans=in_chans,
