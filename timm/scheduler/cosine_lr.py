...
class CosineLRScheduler(Scheduler):
    ...
    def _get_lr(self, t):
        if t < self.warmup_t:
            ...
            if self.t_mul != 1:
                i = math.floor(
                    math.log(1 - t / self.t_initial * (1 - self.t_mul),
                             self.t_mul))
            ...
            if self.cycle_limit == 0 or (self.cycle_limit > 0
                                         and i < self.cycle_limit):
                lrs = [
    ...
    def get_cycle_length(self, cycles=0):
        ...
        if self.t_mul == 1.0:
            ...
            return int(
                math.floor(-self.t_initial * (self.t_mul**cycles - 1) /
                           (1 - self.t_mul)))
